...
ActiveRecord::Schema.define(version: 20181226043222436) do

  create_table "conversations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci", force: :cascade do |t|
    t.integer "sender_id"
